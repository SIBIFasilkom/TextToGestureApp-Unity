...
public class Evaluasi2 : MonoBehaviour
{
    public void Update()
    {
    ...
    [SerializeField] private NamedAnimancerComponent _Animancering;
    ...
    private static string DATA_KUISIONER = "Database/Kuisioner";
    ...
    private IEnumerator SibiAnimationSequence(List<string> komponenKata) {
        ...
        AnimancerState previousStateing = _Animancering.CurrentState;
        ...
        foreach (string kata in komponenKata) {
            if(toggleTransisi.isOn) {
                ...
                stateing = _Animancering.CrossFadeFromStart(kata, fadeDuration);
                ...
                stateing = _Animancering.Play(kata);
                stateing.Time = 0;
            }
        ...
        if (toggleTransisi.isOn) {
            ...
            stateing = _Animancering.CrossFadeFromStart("idle", fadeDuration);
            stateing.Speed = stateSpeed;

        } else {
            _Animancer.Play("idle");
            _Animancering.Play("idle");
        }
    }
